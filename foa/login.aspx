...
<body background="Bright-Lights-Background-Wallpaper.jpg">
        <center>
    <form id="form1" runat="server">
         <h1>
            Office Management system </h1>
        ...
        <p>
            <asp:Button ID="btnLogin" runat="server" Text="Login" OnClick="btnLogin_Click" Width="89px" />&nbsp;</p>
        <p>
